...
namespace AI_Recruitment_Assistant.Api.IdentityEndpoints;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
            ...
            ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                appUser.UserTypeId = ApplicationConstants.UserTypeCandidate;
            }
            ...
            ([FromBody] LoginRequest login, [FromQuery] bool? useCookies, [FromQuery] bool? useSessionCookies, [FromServices] IServiceProvider sp) =>
        {
            ...
            if (signInManager.Context.Items.TryGetValue("AccessTokenResult", out var tokenResult) && tokenResult is CustomAccessTokenResponse jwtTokenResult)
            {
                return TypedResults.Ok(new CustomAccessTokenResponse { AccessToken = jwtTokenResult.AccessToken, ExpiresAt = jwtTokenResult.ExpiresAt });
            }
